...
TOKEN = '5930535769:AAG-5YKY9S-Jmqqj5D5AwzsCuZGzXDnR_NI'
...
def welcome(message):
	...
	bot.send_message(
        ...
        text="Это бот для генерации тестовых пользователей. "\
        "Сколько пользователей тебе нужно?",
...
def message_handler(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text="Не хватило? Можно выбрать ещё :)",
        reply_markup=main_menu_reply_markup
    )
